...
<div class="header-container">
	<img class="windowimg" src="assets/images/Surf_California-08016.jpg">
	<img class="mobileimg" src="assets/images/tcc_header_intermediate_mobile1.jpg">
	<div class="menu">
		<h4>Intermediate</h4>
	</div>
</div>
		...
		<div class="item item1 infoitem1">
			...
			<div class="maxcontainer">
				<div class="contentinformation">
					<h2 class="whiteTitle">Intermediate Surfer</h2>
					<div class="row">
						<div class="col-md-6">
							<h5 class="infotitle">Intermediate:</h5>
							<p>Join the Surf guides! Guaranteed great fun from Orange County to San Diego and Los
								Angeles. From the 2 Star Surfer to a 5 Star surfer we bring you to the right place
								at the right time daily.</p>
