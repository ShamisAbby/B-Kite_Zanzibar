...
function writeRTE() {
   ...
   document.writeln('	</select>');
   document.writeln(    '<img src="img/bold.gif" title="bold" onClick="formatText(event,  \'bold\', \'\')">');
   document.writeln(    '<img src="img/italic.gif" title="Italic" onClick="formatText(event,  \'italic\', \'\')">');
   document.writeln(    '<img src="img/underline.gif" title="Underline" onClick="formatText(event,  \'underline\', \'\')">');
   document.writeln(    '|');
   document.writeln(    '<img src="img/left_just.gif" title="Align Left" onClick="formatText(event,  \'justifyleft\', \'\')">');
   document.writeln(    '<img src="img/centre.gif" title="Center" onClick="formatText(event,  \'justifycenter\', \'\')">');
   document.writeln(    '<img src="img/right_just.gif" title="Align Right" onClick="formatText(event,  \'justifyright\', \'\')">');
   document.writeln(    '<img src="img/justifyfull.gif" title="Justify Full" onclick="formatText(event,  \'justifyfull\', \'\')">');
   document.writeln(    '|');
   document.writeln(    '<img src="img/hr.gif" title="Horizontal Rule" onClick="formatText(event,  \'inserthorizontalrule\', \'\')">');
   document.writeln(    '|');
   document.writeln(    '<img src="img/numbered_list.gif" title="Ordered List" onClick="formatText(event,  \'insertorderedlist\', \'\')">');
   document.writeln(    '<img src="img/list.gif" title="Unordered List" onClick="formatText(event,  \'insertunorderedlist\', \'\')">');
   document.writeln(    '|');
   document.writeln(    '<img src="img/outdent.gif" title="Outdent" onClick="formatText(event,  \'outdent\', \'\')">');
   document.writeln(    '<img src="img/indent.gif" title="Indent" onClick="formatText(event,  \'indent\', \'\')">');
   document.writeln(    '<img src="img/textcolor.gif" title="Text Color" onClick="formatText(event,  \'forecolor\', \'\')">');
   document.writeln(    '<img src="img/bgcolor.gif" title="Background Color" onClick="formatText(event,  \'hilitecolor\', \'\')">');
   document.writeln(    '|');
   document.writeln(    '<img src="img/hyperlink.gif" title="Insert Link" onClick="formatText(event,  \'createlink\')">');
   document.writeln(    '<img src="img/image.gif" title="Add Image" onClick="addImage(event)">');
   document.writeln(    '<img src="img/table.gif" title="Insert Table" onClick="insertTable(event)">');
   document.writeln('</span>');
   document.writeln('<span id="rteTableButtons">');
   document.writeln(    '|');
   document.writeln(    '<img src="img/coladd.gif" title="Add a column" onClick="addTD(event)">');
   document.writeln(    '<img src="img/coldel.gif" title="Delete a column" onClick="delTD(event)">');
   document.writeln(    '|');
   document.writeln(    '<img src="img/colspan1.gif" title="increase column span" onclick="setColspan(event,1)">');
   document.writeln(    '<img src="img/colspan2.gif" title="decrease column span" onclick="setColspan(event,-1)">');
   document.writeln(    '<img src="img/rowspan1.gif" title="increase row span" onclick="setRowspan(event,1)">');
   document.writeln(    '<img src="img/rowspan2.gif" title="decrease row span" onclick="setRowspan(event,-1)">');
   document.writeln(    '|');
   document.writeln(    '<img src="img/rowadd.gif" title="insert a row" onclick="addTR(event)">');
   document.writeln(    '<img src="img/rowdel.gif" title="delete a row" onclick="delTR(event)">');
   document.writeln('</span>');
   ...
   document.writeln('<a id="__kim" style="font-size:8px;font-weight:bolder;font-family:verdana;float:right;text-decoration:none;" href="http://tech.CityPost.ca">&copy;</a>');
   ...
   document.writeln('</select>');
   document.writeln('<input type="checkbox" onclick="toggleMode(event);" />View Source');
