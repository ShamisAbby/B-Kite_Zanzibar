...
<div class="header-container">
	<img class="windowimg" src="assets/images/tcc_header_surfequipment.jpg">
	<img class="mobileimg" src="assets/images/tcc_header_surfequipment.jpg">
	<div class="menu">
		<h4>Surfequipment</h4>
	</div>
</div>
		...
		<ul class="fw-nav-level2">
			...
			<li class="fw-nav-btn fw-nav-selected" id="navbutt_46814_56535"><a class="fw-nav-selected" href="index190d.php?page=137015&amp;cfid=149103729&amp;cftoken=904b09e5e11cbad1-3E911D37-B04E-2DC0-DA1889DD4515BC68" id="navlink_46814_56535">Rates & Location</a>
				<ul class="fw-nav-level3">
					...
					<li class="fw-nav-btn fw-nav-selected" id="navbutt_46827_56535"><a class="fw-nav-selected" href="surfequipment.php" id="navlink_46827_56535">Surf Equipment</a></li>
		...
		<div class="item item1 infoitem1">
			...
			<div class="maxcontainer">
				<div class="contentinformation">
					<h2 class="whiteTitle">Surf Equipment</h2>
					<div class="row">
						<div class="col-md-6">
							<p>Bring your own or borrow ours: We offer a wide range of equipment including wetsuits
								for men and women as well as surfboards for the beginner all the way to expert
								level.
								Surfing on quality equipment is a necessity and we aim to take your surfing to the
								next
								level. We take it upon ourselves to provide this and can be included in your overall
								package. Just ask and we’ll make sure you have the right board under your feet!</p>
							<p>We leave the surf equipment with you so you can go on your own if you'd like!
							</p>
							<p>As a reminder, surfboards are in fact fragile items and if damaged require
								immediate repair. You will be offered equipment insurance if desired upon booking.
							</p>
						...
						<div class="col-md-6">
							<img class="infoimg" src="assets/images/surfequipment_content.jpg">
						</div>
					</div>
				</div>
			</div>
