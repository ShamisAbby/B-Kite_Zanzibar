...
<div class="header-container">
	<img class="windowimg" src="assets/images/tcc_header_advanced.jpg">
	<img class="mobileimg" src="assets/images/tcc_header_beginner_advanced.jpg">
	<div class="menu">
		<h4>Advanced</h4>
	</div>
</div>
		...
		<div class="item item1 infoitem1">
			...
			<div class="maxcontainer">
				<div class="contentinformation">
					<h2 class="whiteTitle">Advanced surfer</h2>
					<div class="row">
						<div class="col-md-6">
							<h5 class="infotitle">Advanced:</h5>
