        ...
        <div class="item item1 infoitem1">
            ...
            <div class="maxcontainer">
                <div class="contentinformation">
                    <h2 class="whiteTitle">The Kite Spots</h2>
                    <div class="row">
                        <div class="col-md-12 surfspotvideo">
                            <p>
                                ...
                                the complete beginners needing a stress-free experience, as well
                                as independent riders looking for untapped spot to session all day long.
                                ...
                                smooth white sand make this island a kiteboarders paradise.
                                Barely 1.5km away from the shore you will find the reef where
                                waves can reach up to 3 meters height. Perfect treat for waves lovers.
                            </p>
                            <!-- <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item"
                                        src="https://www.youtube.com/watch?v=mGpxQW8kF0Q" allowfullscreen></iframe>
                                </div> -->
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h5 class="infotitleOnecol">There are two wind seasons:</h5>
                            <p>
                                From mid-May to October the wind called Kusi blows from South to North coast
                                with average wind speed between 12-19 knots. Constant side-on-shore wind from
                                morning to late evening. (The average water temperature is between 24-28 degrees) <br><br>
                                From mid-December to mid-March the wind called Kaskazi blows from North to South
                                coast with average wind speed between 12-17 knots. Perfect side-on-shore wind
                                conditions almost
                            </p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h5 class="infotitleOnecol">Period</h5>
                            <p>
                                KUSI: Mid May - October Best months July, August. <br>
                                KASKAZI: December - Mid March Best month December, January
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h5 class="infotitleOnecol">Wind</h5>
                            <p>
                                KUSI: Mid May-October S->N side-on-shore 12-19 knots <br>
                                KASKAZI: December-mid March N->S side-on-shore 10-17 knots
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h5 class="infotitleOnecol">Water</h5>
                            <p>
                                Mid May-October the water temperature is about 24*C - 28*C <br>
                                December-mid March the water temperature is about 28*C - 31*C
                            </p>
                        </div>
                    </div>
