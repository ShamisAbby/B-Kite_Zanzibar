...
<div class="header-container">
	<img class="windowimg" src="assets/images/Skydiving_California.jpg">
	<img class="mobileimg" src="assets/images/Skydiving_California.jpg">
	<div class="menu">
		<h4>Point Break Day</h4>
	</div>
</div>
</header>
<div class="logoTcc">
		...
		<ul class="fw-nav-level2">
			...
			<li class="fw-nav-btn fw-nav-selected" id="navbutt_46814_56535"><a class="fw-nav-selected" href="index190d.php?page=137015&amp;cfid=149103729&amp;cftoken=904b09e5e11cbad1-3E911D37-B04E-2DC0-DA1889DD4515BC68" id="navlink_46814_56535">Rates & Location</a>
				<ul class="fw-nav-level3">
					...
					<li class="fw-nav-btn fw-nav-selected" id="navbutt_46829_56535"><a class="fw-nav-selected" href="pointbreakday.php" id="navlink_46829_56535">Point break day</a></li>
		...
		<div class="item item1 infoitem1">
			...
			<div class="maxcontainer">
				<div class="contentinformation">
					<h2 class="whiteTitle">Thrill seekers and adventurers wanted!</h2>
					<div class="row">
						<div class="col-md-6">
							<p>TheCaliCamp has just what you’re looking for. We are introducing “The Point Break
								Day”. </p>
							<h5 class="infotitle">Here’s what you can expect: SURFING and SKYDIVING</h5>
							<ul class="contentlist">
								<li>8 am Pickup at the camp</li>
								<li>Southbound to San Diego looking for the best waves</li>
								<li>2 hour surf session</li>
								<li>Lunch</li>
								<li>2:30 PM SKYDIVING (Views of Downtown San Diego, the ocean, into Mexico and
									beyond)</li>
								<li>After a 13,000 ft freefall, you’ll be as full of adrenaline as you ever may be
									in your life.</li>
								<li>7 PM Beachside bonfire and BBQ</li>
								<li>Let the adrenaline come down while sharing stories, food and drinks with the
									other guests</li>
							</ul>
							<p>Skydiving is done at one of the world’s leading skydive schools: Skydive San Diego
								$169 paid direct to school</p>

							<a class="links" href="booking.php"><button class="bluebutton">Book now!</button></a>
							<a class="links" href="contact.php">Have a question?</a>
						</div>
						<div class="col-md-6">
							<img class="infoimg" src="assets/images/Gallery/IMG_7496-CC.jpg">
							<p>Morning Surf</p>
							<img class="infoimg" src="assets/images/skydiving.jpg">
							<p>Afternoon Skydiving</p>
							<img class="infoimg" src="assets/images/bbq.jpg">
							<p>Evening BBQ & Beach life</p>
							<img class="infoimg" src="assets/images/volley.jpg">
						</div>
					</div>
				</div>
			</div>
