...
<div class="header-container">
	...
	<img class="mobileimg" src="assets/images/tcc_header_surfguiding_mobile.jpg">
	<div class="menu">
		<h4>Surf Guiding</h4>
	</div>
</div>
		...
		<ul class="fw-nav-level2">
			...
			<li class="fw-nav-btn fw-nav-selected" id="navbutt_46814_56535"><a class="fw-nav-selected" href="index190d.php?page=137015&amp;cfid=149103729&amp;cftoken=904b09e5e11cbad1-3E911D37-B04E-2DC0-DA1889DD4515BC68" id="navlink_46814_56535">Rates & Location</a>
				<ul class="fw-nav-level3">
					...
					<li class="fw-nav-btn fw-nav-selected" id="navbutt_46826_56535"><a class="fw-nav-selected" href="surfguiding.php" id="navlink_46826_56535">Surf Guiding</a></li>
		...
		<div class="item item1 infoitem1">
			...
			<div class="maxcontainer">
				<div class="contentinformation">
					<h2 class="whiteTitle">Surf Guiding: From Beginners to Pro's</h2>
					<div class="row">
						<div class="col-md-6">
							<h5 class="infotitle">You're An Absolute Beginner:</h5>
							<p>You can join our guided surf sessions and go for it with the help of your guide.
								But we highly recommend to take the Basic Surf Training on Monday.</p>
							<h5 class="infotitle">Includes:</h5>
							<ul class="contentlist">
								<li>Ocean safety discussion</li>
								<li>Theory lesson on building comfort in the surf</li>
								<li>Equipment training</li>
								<li>Hands on surf session</li>
								<li>Paddletechnique course</li>
								<li>Breathing and endurance tips</li>
							</ul>
							<p>Good for first time surfers and advanced beginners.</p>
							<h5 class="infotitle">You're Already A Surfer</h5>
							<p>Join the Surf guides! Guaranteed great fun from Orange County to San Diego and Los
								Angeles.
								From the 2 Star Surfer to a 5 Star surfer we bring you to the right place at the
								right time daily.</p>
							<h5 class="infotitle">What Is Surf Guiding?</h5>
							<p>Surf Guiding
								Our surf guides are there to get you to the best spot and offer tons of useful and
								helpful advice. Think of your surf guides like mountain sherpas : ) Really cool,
								happy locals who are the best people to lead you on any adventure in their home
								terrain.
								They have all of the info you need to know:</p>
							<ul class="contentlist">
								<li>Where to be and when to be there</li>
								<li>How to stay safe</li>
								<li>How to improve your skills</li>
							</ul>
							<p>
								And essentially all of the things you need to know to enjoy your sessions from start
								to finish. For safety reasons, we ask you to always respect the words of your guides
								as your safety is our number 1 priority.</p>
							</p>
							<h5 class="infotitle">What does a typical Day look like.</h5>
							<ul class="contentlist">
								<li>The Guide picks you up between 06:30 and 10:00 and you drive to the Surf spot: 1
									to 2 hours of surfing</li>
								<li>The Guide brings you back to the Camp, so by noon you are ready for lunch
									(unless otherwise you are on one of our scheduled "day trips"</li>
								<li>Between 14:00 and 15:00 the Guide picks you up for a second Surf Session.</li>
								<li>Your back around 17:00 for some relaxation, yoga, dinner, socializing, sleep and
									do it all over again.</li>
							</ul>
							<h5 class="infotitle">Sunset Surf</h5>
							<p>Once a week we have a special Sunset Surf. Our Camp Boss Dave Cinquini brings you
								personally to his secret Sunset Spot.
								After a unforgettable Surf session at a nearby beach, we'll follow it up with a
								beach bonfire and bbq courtesy of TheCaliCamp.</p>
							<p>For a great surf experience you don't just need good waves, you also need great
								equipment. Know more about our <a class="links" href="surfequipment.php">Equipment</a></p>
							<a class="links" href="booking.php"><button class="buttonformular">Book
									now!</button></a>
							<a class="links" href="contact.php">Have a question?</a>
						</div>
						<div class="col-md-6">
							<img class="infoimg" src="assets/images/surfguiding_content.jpg">
						</div>
					</div>
				</div>
			</div>
